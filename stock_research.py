...
BUSINESS_GROUPS = {
    ...
    "Payment processors": ["FISV", "GPN", "FIS"],
    ...
    "Power distribution equipment": ["FPS", "POWL", "NVT"],
...
BUSINESS_NOTES = {
    ...
    "FPS": "Electrical distribution equipment for data centers, the grid and energy-intensive facilities.",
    "POWL": "Custom electrical distribution systems with greater exposure to energy and industrial projects.",
    "NVT": "Electrical connection and protection products across a broader industrial and infrastructure portfolio.",
